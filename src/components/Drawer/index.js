  ...
  const deleteMargin = () => {
    ...
    return (
        <>
           ...
           onMouseLeave={deleteMargin} >
        <ul className={s.navbar_nav}>
            <li className={s.logo}>
                <a href="#" className={s.nav_link}>         
                    <span className={s.link_text}>Menu</span>
                    <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fad"
                  ...
                  >
                    <g className="fa-group">
                      <path
                        ...
                        className={s.fa_secondary}
                      ></path>
                      <path
                        fill="currentColor"
                        d="M415.89 273L280.34 409a23.77 23.77 0 0 1-33.79 0L224 386.26a23.94 23.94 0 0 1 0-33.89L320.11 256l-96-96.47a23.94 23.94 0 0 1 0-33.89l22.52-22.59a23.77 23.77 0 0 1 33.79 0L416 239a24 24 0 0 1-.11 34z"
                        className={s.fa_primary}
                      ></path>
                    </g>
                  </svg>
            ...
            <li className={s.nav_item}>
                <a href="#" className={s.nav_link}> 
                  ...
                  <span className={s.link_text}>Cats</span>
                </a>         
            ...
            <li className={s.nav_item}>
                <a href="#" className={s.nav_link}>
                    ...
                    <span className={s.link_text}>Aliens</span>
                  </a>
            </li>
            ...
            <li className={s.nav_item}>
                <a href="#" className={s.nav_link}>
                    ...
                    <span className={s.link_text}>Space</span>
                  </a>
            </li>
            ...
            <li className={s.nav_item}>
                <a href="#" className={s.nav_link}>
                  ...
                  <span className={s.link_text}>Shuttle</span>
                </a>
              </li>
